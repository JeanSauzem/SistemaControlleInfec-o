    ...
    <body>
        ...
        <div class="container">
            <center>
                <div class=row>
                    <div class="col-sm-21">
                        <h2>Lista dos Denominadores</h2>
                    </div>
                </div>
            </center>
            <div class="row">
                <div class="col-sm-offset-2">
                    <form action="verdenominador.php" name="samepes" class="form-horizontal"  method="post" role="form">
        ...
        <div class="row">
            <div class="col-sm-offset-1">
                <?php
                $deno = new DenominadoresDAO();
                if (isset($_POST["mes"]) && isset($_POST["Ano"]) && isset($_POST["unidade"])) {
                    echo "<table class=\"table\">";
                    echo "<tr><td>Unidade</td><td>Mês</td><td>Ano</td><td>cateter</td><td>Solda</td><td>Respirador</td><td>Ações</td></tr>";
                    $deno->listatodostabelaselect($_POST["mes"], $_POST["Ano"], $_POST["unidade"]);
                    echo "</table>";
                } else {
                    echo "<table class=\"table\">";
                    echo "<tr><td>Unidade</td><td>Mês</td><td>Ano</td><td>cateter</td><td>Solda</td><td>Respirador</td><td>Ações</td></tr>";
                    ...
                    $deno->listatodostabela();
                    echo "</table>";
                }
                if ($_SESSION["msg"] == 1) {
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Denominador Deletado com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                }else  if ($_SESSION["msg"] == 2){
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Denominador Alterado com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                }
                ?>
            </div>
