    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-offset-2">
                    <form action="verusuario.php" name="samepes" class="form-horizontal"  method="post" role="form">
        ...
        <div class="row">
            <div class="col-sm-offset-1">
                ...
                $con = new ConexaoDAO();
                $usuario = new UsuariosDAOs();
                $con->conexao();
                if (isset($_POST["usuario"])) {
                    echo "<table class=\"table\">";
                    echo "<tr><td>Nome </td><td>Tipo</td><td>Matricula</td><td>funcao</td><td>ações</td></tr>";
                    $usuario->listatodostabelanome($_POST["usuario"]);
                    echo "</table>";
                } else {
                    echo "<table class=\"table\">";
                    echo "<tr><td>Nome </td><td>Tipo</td><td>Matricula</td><td>funcao</td><td>ações</td></tr>";

                    $usuario->listatodostabela();
                    echo "</table>";
                }
                if ($_SESSION["msg"] == 1) {
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Usuario Deletado com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                }else   if ($_SESSION["msg"] == 2) {
                      echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Usuario Alterar com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                }else   if ($_SESSION["msg"] == 3) {
                         echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Usuario esta logado, não pode se deletar</div></div>";
                    $_SESSION["msg"] = 0;
                }
                ?>
            </div>
