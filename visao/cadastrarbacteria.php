...
<html lang="en">
    ...
    <center>
        <div class="container">
            <div class=row>
                <div class="col-sm-21">
                    <h2>Cadastro de Bacteria</h2>
                </div>
            </div>
    </center>
    <div class="row">
        <div class="col-sm-offset-3">
            <form class="form-horizontal" action="cadastrarbacteria.php" method="post" role="form">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="NomeBacteria">Nome da Bacteria:</label>
                    <div class="col-sm-5">
                        <input type="type"  class="form-control" id="campos2" name="NomeBacteria" placeholder="Digite o Nome da Bacteria">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">          
                        <select class="form-control"  id="selecao" name="TipoBacteria">
                            <option value="Gran Positivos">Gran Positivos</option>
                            <option value="Gran Negativos">Gran Negativos</option>
...
<div class="col-sm-offset-3">
    <div class="col-sm-7">
        ...
        if (isset($_POST["TipoBacteria"]) && isset($_POST["NomeBacteria"])) {
            ...
            if ($BacteriaDAO->Inserir_Bacteria($Bacteria) == 1) {
                echo"<div class=\"row\"><div class=\"alert alert-danger\" role=\"alert\">
  <span class=\"glyphicon glyphicon-exclamation-sign\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span> Bacteria Cadastrada  com Sucesso</div></div>";
            } else {
                echo"<div class=\"row\"><div class=\"alert alert-danger\" role=\"alert\">
  <span class=\"glyphicon glyphicon-exclamation-sign\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Erro ao efetuar o Cadastro da Bacteria</div></div>";
            }
        }
        ?>
    </div>
