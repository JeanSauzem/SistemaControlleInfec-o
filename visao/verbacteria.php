    ...
    <body>
        ...
        <div class="container">
            <center>
                <div class=row>
                    <div class="col-sm-21">
                        <h2>Lista de Bacteria</h2>
                    </div>
                </div>
            </center>
            <div class="row">
                <div class="col-sm-offset-2">
                    <form action="verbacteria.php" name="samepes" class="form-horizontal"  method="post" role="form">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="nomeb">Nome da Bacteria</label>
                            <div class="col-sm-5">
                                <input type="text" name="nomeb" class="form-control">
        ...
        <div class="row">
            <div class="col-sm-offset-1">
                ...
                if (isset($_POST["nomeb"])) {
                    if (!$bacteria->validarpesquisaBac($_POST["nomeb"])) {
                        
                    } else {
                        echo "<table class=\"table\">";
                        echo "<tr><td>Bacteria</td><td>Tipo</td><td>Ações</td></tr>";
                        $bacteria->listatodostabelapesqbac($_POST["nomeb"]);
                    }
                } else {
                    echo "<table class=\"table\">";
                    echo "<tr><td>Bacteria</td><td>Tipo</td><td>Ações</td></tr>";
                    $con->conexao();
                    $bacteria->listatodostabela();
                    echo "</table>";
                }
                if ($_SESSION["msg"] == 1) {
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Bacteria Deletada com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                } else if ($_SESSION["msg"] == 2) {
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Bacteria Alterada com sucesso</div></div>";
                    $_SESSION["msg"] = 0;
                }
                    ?>
            </div>
