    ...
    <body>
        ...
        <div class="container">
            <center>
                <div class=row>
                    <div class="col-sm-21">
                        <h2>Lista de Infecção</h2>
                    </div>
                </div>
            </center>
            <div class="row">
                <div class="col-sm-offset-2">
                    <form action="verinfeccao.php" name="samepes" class="form-horizontal"  method="post" role="form">
            ...
            <div class="row">
                <div class="col-sm-offset-1">
                    ...
                    if (isset($_POST["same"])) {
                        ...
                        echo "<tr><td>Same</td><td>NomePaciente</td><td>procedimento</td><td>unidade</td><td>Bacteria</td><td>Topografia</td><td>obito</td><td>Ações</td></tr>";
                        $infeccao->listatodostabelasame($same);
                        $infeccao->listatodostabelasemcirurgiasame($same);
                    } else {
                        echo "<table class=\"table\">";
                        echo "<tr><td>Same</td><td>NomePaciente</td><td>procedimento</td><td>unidade</td><td>Bacteria</td><td>Topografia</td><td>obito</td><td>Ações</td></tr>";
                        $infeccao->listatodostabela();
                        $infeccao->listatodostabelasemcirurgia();
                        echo "</table>";
                    }
                    if ($_SESSION["msg"] == 1) {
                        echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Infeccao Deletada com sucesso</div></div>";
                        $_SESSION["msg"] = 0;
                    }else if ($_SESSION["msg"] == 2) {
                    echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Infeccão alterada com sucesso</div></div>";
                        $_SESSION["msg"] = 0;
