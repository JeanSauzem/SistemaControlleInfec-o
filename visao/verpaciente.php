        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-offset-2">
                    <form action="verpaciente.php" name="samepes" class="form-horizontal"  method="post" role="form">
            ...
            <div class="row">
                <div class="col-sm-offset-1">
                    ...
                    if (isset($_POST["same"])) {
                        ...
                        echo "<tr><td>Same</td><td>NomePaciente</td><td>Idade</td><td>genero</td><td>Ações</td></tr>";
                        $paciente->listatodostabelasame($_POST["same"]);
                        echo "</table>";
                    } else {
                        echo "<table class=\"table\">";
                        echo "<tr><td>Same</td><td>NomePaciente</td><td>Idade</td><td>genero</td><td>Ações</td></tr>";

                        $paciente->listatodostabela();
                    }
                    if ($_SESSION["msg"] == 1) {
                        echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Paciente Deletado com sucesso</div></div>";
                        $_SESSION["msg"] = 0;
                    } else if ($_SESSION["msg"] == 2) {
                        echo"<div class=\"row\"><div class=\"alert alert-success\" role=\"alert\">
  <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span>
  <span class=\"sr-only\">Error:</span>Paciente Alterado com sucesso</div></div>";
                        $_SESSION["msg"] = 0;
                    }
                    ?>
                </div>
